...
const DetailSearch = () => {
    ...
    return (
      <div className='w-full bg-white rounded-md flex justify-between items-end md:items-center flex-col md:flex-row gap-4 px-4 py-6 drop-shadow-lg border border-solid border-neutral-100'>
